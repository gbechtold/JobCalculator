// src/features/calculator/ui/sections/ResultsSection.tsx
'use client';
...
export const ResultsSection = () => {
  ...
  return (
    <section className="border-t pt-8">
      <div className="bg-gradient-to-r from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-900 p-6 rounded-lg">
