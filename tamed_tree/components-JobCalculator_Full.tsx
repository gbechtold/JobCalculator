...
const JobCalculator = () => {
  ...
  const calculateReach = () => {
    ...
    const demoFactors = {
      ...
      migration_yes: 0.40,
      migration_no: 0.60,
      education_professional: 0.60,
      education_trained: 0.30,
      education_higher: 0.10
    };
    ...
    const wechselgruendeBoost = campaignFactors.wechselgruende.length * 0.20;
    const anreizeBoost = campaignFactors.anreize.length * 0.25;
    const hinderungsReduction = campaignFactors.hinderungsgruende.length * -0.20;
    const loesungsBoost = campaignFactors.loesungsansaetze.length * 0.25;

    const campaignMultiplier = 1 + wechselgruendeBoost + anreizeBoost + 
      (hinderungsReduction * -1) + loesungsBoost;
            ...
            <section>
              ...
              <div className="space-y-4 mb-6">
                ...
                <Select 
                  ...
                  onValueChange={(value) => 
                    setRequirements(prev => ({...prev, segment: value}))
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
              ...
              <div className="space-y-4 mb-6">
                ...
                <Select 
                  ...
                  onValueChange={(value) => 
                    setRequirements(prev => ({...prev, ageGroup: value}))
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
              ...
              <div className="space-y-4 mb-6">
                ...
                <Select 
                  ...
                  onValueChange={(value) => 
                    setRequirements(prev => ({...prev, demographic: value}))
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
              ...
              <div className="space-y-4 mb-6">
                ...
                <Slider
                  ...
                  onValueChange={([value]) => 
                    setRequirements(prev => ({...prev, distance: value}))}
                  max={100}
                  step={5}
                />
              </div>
                  ...
                  <div key={key} className="flex items-center space-x-2">
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        setPowerUps(prev => ({...prev, [key]: checked}))
                      }
                    />
                    <span>{label}</span>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="space-y-4">
                  ...
                  <Slider
                    ...
                    onValueChange={([value]) => 
                      setMarketing(prev => ({...prev, reach: value}))}
                    max={100}
                    step={5}
                  />
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <Slider
                    ...
                    onValueChange={([value]) => 
                      setMarketing(prev => ({...prev, duration: value}))}
                    min={7}
                    max={365}
                    step={7}
                  />
